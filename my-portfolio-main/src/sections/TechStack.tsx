...
const skillCategories: Record<string, string[]> = {
  ...
  Databases: ["MySQL", "MongoDB", "SQL", "Convex"],
  Frontend: ["React.js", "React Native", "Next.js", "Tailwind CSS", "shadcn/ui", "Jetpack Compose", "HTML5", "CSS3"],
  Backend: ["Node.js", "Express.js", "FastAPI", "Convex", "REST APIs", "API Integration", "Authentication", "Clerk", "EdgeStore", "Postman", "Swagger"],
