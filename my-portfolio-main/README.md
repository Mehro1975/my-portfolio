...
- **Switchable Profile Avatar:** Custom profile image rendering.
...
- **Konami Code Easter Egg:** Listening for classic trigger keys ("harsh", "jha", or the classic Konami sequence) to activate interactive falling confetti achievements.
...
* [src/config/site.ts](file:///c:/Users/Harsh%20Kumar%20Jha/Downloads/my-portfolio-main/my-portfolio-main/src/config/site.ts)
